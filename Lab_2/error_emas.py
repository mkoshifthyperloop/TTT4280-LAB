...
meas = ["50m1.bin", "50m2.bin", "50m3.bin", "50m4.bin", "50m5.bin"]
thetas = []
for m in meas:
    theta = find_theta_one(m)
    thetas.append(theta)

print(thetas)
print("uncertianty {}, mean {}".format(np.std(thetas), np.mean(thetas)))